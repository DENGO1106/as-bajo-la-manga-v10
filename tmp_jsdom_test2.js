...
try {
  const dom = new JSDOM(html, {
    ...
    beforeParse(window) {
      ...
      // Provide minimal storage shims to avoid DOMExceptions
      try {
        Object.defineProperty(window, 'localStorage', { value: { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }, writable: false });
        Object.defineProperty(window, 'sessionStorage', { value: { getItem:()=>null, setItem:()=>{}, removeItem:()=>{} }, writable: false });
      } catch (e) {
        // ignore
      }
    }
  ...
  console.error('CREATE JSDOM FAILED:', e && e.stack ? e.stack : e);
  process.exit(1);
}
